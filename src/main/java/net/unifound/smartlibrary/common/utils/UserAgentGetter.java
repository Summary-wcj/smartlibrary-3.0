...
public class UserAgentGetter {
    ...
    public String getBrowser(){
        if (null == userAgent){
            ...
            if (userAgentString.contains("Postman")){
                return "Postman";
            }else {
    ...
    public String getOS(){
        if (null == userAgent){
            ...
            String requestOs = userAgent.getOperatingSystem().getName();
            String systemOs=System.getProperty("os.name");
            return requestOs.equalsIgnoreCase("UNKNOWN")? systemOs:requestOs;
        }
    }
    /**
     * 获取设备型号
    ...
    public String getDevice(){
        if (null == userAgent){
            ...
            if (userAgentString.contains("Android")){
                ...
                return "iPad";
            } else if (userAgentString.contains("Postman")) {
                return "Postman";
            } else {
                return getOS().trim();
            }
